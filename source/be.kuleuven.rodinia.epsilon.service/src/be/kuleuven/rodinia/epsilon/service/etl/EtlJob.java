...
public class EtlJob extends WorkspaceJob {
	...
	protected EmfModel createTarget() {
		...
		emfModel.setModelFileUri(parameter.getTargetModelURI());
	...
	public static EtlJob createJob(EtlTransformParameter transformParameter) {
		EtlJob job = new EtlJob(transformParameter.getTransformName());
		job.setEtlTransformParameter(transformParameter);
		return job;
	}
