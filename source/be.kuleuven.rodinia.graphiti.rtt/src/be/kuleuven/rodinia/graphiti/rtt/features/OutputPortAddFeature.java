...
public class OutputPortAddFeature extends AbstractAddShapeFeature{

	public OutputPortAddFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		final OutputPort addedClass = (OutputPort) context.getNewObject();
 ...
 
        {
            ...
            roundedRectangle.setStyle(StyleUtil.getStyleForOutputPort(getDiagram()));
        ...
        // SHAPE WITH ELLIPSE
        {
            ...
            el.setStyle(StyleUtil.getStyleForOutputPort(getDiagram()));
            el.setLineWidth(2);
            if (LR == true){
