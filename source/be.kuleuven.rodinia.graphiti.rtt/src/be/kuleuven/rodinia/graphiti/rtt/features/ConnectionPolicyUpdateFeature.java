...
public class ConnectionPolicyUpdateFeature extends AbstractUpdateFeature {
 
    public ConnectionPolicyUpdateFeature(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public boolean canUpdate(IUpdateContext context) {
        ...
        return (bo instanceof ConnectionPolicy);
    }
