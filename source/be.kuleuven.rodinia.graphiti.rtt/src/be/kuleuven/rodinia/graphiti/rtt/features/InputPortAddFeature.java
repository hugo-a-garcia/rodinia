...
public class InputPortAddFeature extends AbstractAddShapeFeature{
	
	public InputPortAddFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		final InputPort addedClass = (InputPort) context.getNewObject();
        ...
        // SHAPE WITH ELLIPSE
        {
            ...
            el.setStyle(StyleUtil.getStyleForInputPort(getDiagram()));
            el.setLineWidth(2);
            if (LR == true){
