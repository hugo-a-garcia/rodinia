...
public class AddTaskContextFeature extends AbstractAddShapeFeature {
	...
	public AddTaskContextFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		TaskContext addedClass = (TaskContext) context.getNewObject();
 ...
 
        {
            ...
            roundedRectangle.setForeground(manageColor(TASK_CONTEXT_FOREGROUND));
            roundedRectangle.setBackground(manageColor(TASK_CONTEXT_BACKGROUND));
