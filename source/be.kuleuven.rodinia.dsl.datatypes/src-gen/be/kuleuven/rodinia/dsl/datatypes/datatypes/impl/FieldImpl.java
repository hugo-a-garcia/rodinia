 ...
 * <ul>
 *   <li>{@link be.kuleuven.rodinia.dsl.datatypes.datatypes.impl.FieldImpl#isMany <em>Many</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.datatypes.datatypes.impl.FieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link be.kuleuven.rodinia.dsl.datatypes.datatypes.impl.FieldImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldImpl extends MinimalEObjectImpl.Container implements Field
{
  ...
  public void setMany(boolean newMany)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.FIELD__MANY, oldMany, many));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DatatypesPackage.FIELD__MANY:
        return isMany();
