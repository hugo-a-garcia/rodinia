 ...
 * generated by Xtext
 */
package be.kuleuven.rodinia.dsl.rtt.formatting;
...
public class RttStructureFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private RttStructureGrammarAccess _rttStructureGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._rttStructureGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._rttStructureGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._rttStructureGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._rttStructureGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._rttStructureGrammarAccess.getML_COMMENTRule();
