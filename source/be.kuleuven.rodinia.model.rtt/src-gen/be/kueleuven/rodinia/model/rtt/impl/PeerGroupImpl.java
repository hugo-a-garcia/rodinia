...
public class PeerGroupImpl extends MinimalEObjectImpl.Container implements PeerGroup
{
  ...
  public void setCoordinator(TaskContext newCoordinator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RttPackage.PEER_GROUP__COORDINATOR, oldCoordinator, coordinator));
  }
  ...
  public EList<TaskContext> getMembers()
  {
    if (members == null)
    {
      members = new EObjectResolvingEList<TaskContext>(TaskContext.class, this, RttPackage.PEER_GROUP__MEMBERS);
    }
    return members;
  }
