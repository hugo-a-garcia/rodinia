 ...
 * <ul>
 *   <li>{@link be.kueleuven.rodinia.model.rtt.impl.SlaveImpl#getName <em>Name</em>}</li>
 *   <li>{@link be.kueleuven.rodinia.model.rtt.impl.SlaveImpl#getTaskContext <em>Task Context</em>}</li>
 *   <li>{@link be.kueleuven.rodinia.model.rtt.impl.SlaveImpl#getMaster <em>Master</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SlaveImpl extends MinimalEObjectImpl.Container implements Slave
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RttPackage.SLAVE__NAME, oldName, name));
  }
  ...
  public TaskContext getTaskContext()
  {
    if (taskContext != null && taskContext.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RttPackage.SLAVE__TASK_CONTEXT, oldTaskContext, taskContext));
      }
    }
    return taskContext;
  }
  ...
  public void setTaskContext(TaskContext newTaskContext)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RttPackage.SLAVE__TASK_CONTEXT, oldTaskContext, taskContext));
  }
  ...
  {
    if (eContainerFeatureID() != RttPackage.SLAVE__MASTER) return null;
   ...
   * @generated
   */
  public Activity basicGetMaster()
  {
    if (eContainerFeatureID() != RttPackage.SLAVE__MASTER) return null;
   ...
   * @generated
   */
  public NotificationChain basicSetMaster(Activity newMaster, NotificationChain msgs)
  {
    msgs = eBasicSetContainer((InternalEObject)newMaster, RttPackage.SLAVE__MASTER, msgs);
    return msgs;
  }
  ...
  {
    if (newMaster != eInternalContainer() || (eContainerFeatureID() != RttPackage.SLAVE__MASTER && newMaster != null))
    {
      ...
      if (newMaster != null)
        msgs = ((InternalEObject)newMaster).eInverseAdd(this, RttPackage.ACTIVITY__SLAVE, Activity.class, msgs);
      msgs = basicSetMaster(newMaster, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RttPackage.SLAVE__MASTER, newMaster, newMaster));
  }
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
  {
    ...
    {
      case RttPackage.SLAVE__MASTER:
        return eInternalContainer().eInverseRemove(this, RttPackage.ACTIVITY__SLAVE, Activity.class, msgs);
    }
